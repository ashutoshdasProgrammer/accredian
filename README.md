...
- Generated a Figma model for the website and let it redesigned it
...
- Looked for "sql injections", "XSS" and other vulnerabilites so that i can make the website more secure.
- Implemented a backend route in app/api/leads/routes.ts so that we could have implemented mock data and tested the website in real-world environment.
